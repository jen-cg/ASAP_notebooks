...
set model_path = /arc5/home/jglover/ASAP/asap_lib/data/grids/standard/sphere/

#MARCS binary format (.true.) or MARCS ASCII web format (.false.)?
set marcs_binary = '.false.'

set model1 = s5500_g+2.5_m1.0_t02_st_z-4.00_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model2 = s5500_g+2.5_m1.0_t02_st_z-3.00_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model3 = s5500_g+3.0_m1.0_t05_st_z-4.00_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model4 = s5500_g+3.0_m1.0_t02_st_z-3.00_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model5 = s5750_g+2.5_m1.0_t02_st_z-5.00_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model6 = s5750_g+2.5_m1.0_t02_st_z-3.00_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model7 = s5750_g+3.0_m1.0_t02_st_z-4.00_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod
set model8 = s5750_g+3.0_m1.0_t05_st_z-3.00_a+0.40_c+0.00_n+0.00_o+0.40_r+0.00_s+0.00.mod

#enter here the values requested for the interpolated model 
foreach Tref   ( 5636.0 )
foreach loggref ( 2.54 )
foreach zref ( -3.2 )

set modele_out = scratch
set modele_out2 = /arc5/home/jglover/ASAP/${Tref}g${loggref}z${zref}.alt
...
/usr/local/bin/interpol_modeles <<EOF
'${model_path}/${model1}'
'${model_path}/${model2}'
'${model_path}/${model3}'
'${model_path}/${model4}'
